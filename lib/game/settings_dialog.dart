          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('SFX Volume', style: GoogleFonts.vt323(fontSize: 28, color: Colors.white)),
                  Text('${_visualSfxVolume.round()}', style: GoogleFonts.vt323(fontSize: 24, color: Colors.white)),
                ],
              ),
              SliderTheme(
                data: SliderTheme.of(context).copyWith(
