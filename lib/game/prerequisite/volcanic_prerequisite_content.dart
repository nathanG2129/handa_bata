...
class VolcanicPrerequisiteContent extends StatefulWidget {
  ...
  const VolcanicPrerequisiteContent({
    super.key,
  ...
  @override
  VolcanicPrerequisiteContentState createState() => VolcanicPrerequisiteContentState();
}

class VolcanicPrerequisiteContentState extends State<VolcanicPrerequisiteContent> {
